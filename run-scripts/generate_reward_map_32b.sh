...
# Common parameters
COMMON_PARAMS="--mode generate --model-id TRITON_QWEN_32B --workspace-radius 320 --reward-calculation-radius 64 --resolution 8 --verbose True"
