...
class NPZPlotter:
    def __init__(
        ...
        npz_files: str | dict,
        plot_title: str = None,
        text_verbosity: bool = False,
    ) -> None:
        """Initializes the NPZPlotter class and loads data from the specified .npz file(s).

        Args:
            npz_files (str | dict): Either a single file path (str) or a dictionary where keys are legend labels and values are file paths.
        ...
        if isinstance(npz_files, str):
            ...
            self.npz_files = {
                label: file_path / file for label, file in npz_files.items()
            }
    ...
    def _gen_plot(self) -> None:
        ...
        if self.plot_title == None:
            ...
            plt.title("Evaluation Results for " + self.plot_title, font)

        plt.xticks(fontsize=tick_fontsize)
        plt.yticks(fontsize=tick_fontsize)
        plt.grid()
        plt.ylim(
            bottom=min(np.min(dataset["results"]) for dataset in self.data.values()),
            top=None,
        )
    ...
    def save(self, path: str) -> None:
        ...
        Args:
            path (str): Path in which to save the plot.
        """
        self._gen_plot()
...
if __name__ == "__main__":
    ...
    npz_files_one_shot_with_example_binary = {
        ...
        "QWEN-7b-Instruct": "src/FM3_MicRo/control_models/2025-02-12_10-50-48_llm_triton_qwen_7b_binary_rewards_1_example_explanation_1000000-steps_5-obs_ep-time-360.0/evaluations.npz",
        ...
        "QWEN-32b-Instruct": "src/FM3_MicRo/control_models/2025-02-02_18-32-35_llm_triton_qwen_32b_binary_rewards_1_example_explanation_1000000-steps_5-obs_ep-time-360.0/evaluations.npz",
        "sparse": "src/FM3_MicRo/control_models/2025-01-23_15-57-24_sparse_1000000-steps_5-obs_ep-time-360.0/evaluations.npz",
        "delta_r": "src/FM3_MicRo/control_models/2025-01-23_15-57-24_delta_r_1000000-steps_5-obs_ep-time-360.0/evaluations.npz",
    }
    ...
    npz_files_3b = {
        ...
        "continuous one-shot with explanation": "src/FM3_MicRo/control_models/2025-01-20_12-13-39_llm_triton_qwen_3b_continuous_rewards_1_example_explanation_1000000-steps_5-obs_ep-time-360.0/evaluations.npz",
        ...
        "binary one-shot with explanation": "src/FM3_MicRo/control_models/2025-01-21_06-30-08_llm_triton_qwen_3b_binary_rewards_1_example_explanation_1000000-steps_5-obs_ep-time-360.0/evaluations.npz",
        "sparse": "src/FM3_MicRo/control_models/2025-01-23_15-57-24_sparse_1000000-steps_5-obs_ep-time-360.0/evaluations.npz",
        "delta_r": "src/FM3_MicRo/control_models/2025-01-23_15-57-24_delta_r_1000000-steps_5-obs_ep-time-360.0/evaluations.npz",
    }
    ...
    npz_files_7b = {
        ...
        "continuous one-shot with explanation": "src/FM3_MicRo/control_models/2025-01-21_22-07-43_llm_triton_qwen_7b_continuous_rewards_1_example_explanation_1000000-steps_5-obs_ep-time-360.0/evaluations.npz",
        ...
        "binary one-shot with explanation": "src/FM3_MicRo/control_models/2025-02-12_10-50-48_llm_triton_qwen_7b_binary_rewards_1_example_explanation_1000000-steps_5-obs_ep-time-360.0/evaluations.npz",
        "sparse": "src/FM3_MicRo/control_models/2025-01-23_15-57-24_sparse_1000000-steps_5-obs_ep-time-360.0/evaluations.npz",
        "delta_r": "src/FM3_MicRo/control_models/2025-01-23_15-57-24_delta_r_1000000-steps_5-obs_ep-time-360.0/evaluations.npz",
    }
    ...
    npz_files_14b = {
        ...
        "continuous one-shot with explanation": "src/FM3_MicRo/control_models/2025-01-24_14-26-37_llm_triton_qwen_14b_continuous_rewards_1_example_explanation_1000000-steps_5-obs_ep-time-360.0/evaluations.npz",
        ...
        "binary one-shot with explanation": "src/FM3_MicRo/control_models/2025-01-28_09-47-00_llm_triton_qwen_14b_binary_rewards_1_example_explanation_1000000-steps_5-obs_ep-time-360.0/evaluations.npz",
        "sparse": "src/FM3_MicRo/control_models/2025-01-23_15-57-24_sparse_1000000-steps_5-obs_ep-time-360.0/evaluations.npz",
        "delta_r": "src/FM3_MicRo/control_models/2025-01-23_15-57-24_delta_r_1000000-steps_5-obs_ep-time-360.0/evaluations.npz",
    }
    ...
    npz_files_32b = {
        ...
        "continuous one-shot with explanation": "src/FM3_MicRo/control_models/2025-01-31_11-20-05_llm_triton_qwen_32b_continuous_rewards_1_example_explanation_1000000-steps_5-obs_ep-time-360.0/evaluations.npz",
        ...
        "binary one-shot with explanation": "src/FM3_MicRo/control_models/2025-02-02_18-32-35_llm_triton_qwen_32b_binary_rewards_1_example_explanation_1000000-steps_5-obs_ep-time-360.0/evaluations.npz",
        "sparse": "src/FM3_MicRo/control_models/2025-01-23_15-57-24_sparse_1000000-steps_5-obs_ep-time-360.0/evaluations.npz",
        "delta_r": "src/FM3_MicRo/control_models/2025-01-23_15-57-24_delta_r_1000000-steps_5-obs_ep-time-360.0/evaluations.npz",
    }
    ...
    plotter = NPZPlotter(
        npz_files=npz_files_3b, plot_title="QWEN-3B-Instruct", text_verbosity=True
    )
    plotter.print()
    plotter.plot()
    # plotter.save()
